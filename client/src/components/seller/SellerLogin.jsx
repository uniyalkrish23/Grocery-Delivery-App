        ...
        items-center text-sm text-gray-600'>
            ...
            rounded-lg shadow-xl border border-gray-200'>
                ...
                <div className='w-full'>
                    ...
                    id="email" className='border border-gray-200 rounded w-full p-2 mt-1 outline-primary'
                    required/>
                </div>
                <div className='w-full'>
                    <p>Password</p>
                    <input onChange={(e)=>setPassword(e.target.value)} value={password} type='password' placeholder='Enter Your Password' 
                    id="password" className='border border-gray-200 rounded w-full p-2 mt-1 outline-primary'
                    required/>
                </div>
